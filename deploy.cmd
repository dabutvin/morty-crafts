...
call npm install angular2 
IF %ERRORLEVEL% NEQ 0 (
  echo Unable to install angular2
  goto error
)

call npm install rxjs 
IF %ERRORLEVEL% NEQ 0 (
  echo Unable to install rxjs
  goto error
)
...
:buildtypescript
echo Building TypeScript: public\app\boot.js (using %tsc%)
%tsc% -m system --moduleResolution node --experimentalDecorators --sourcemap --outDir public\app\ public\app\boot.ts
goto Deployment
